...
//	if (hConnect)
//		hRequest = WinHttpOpenRequest(hConnect, L"GET", L"/v1/data/app/rbac",
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	char sPostData[500] = "{ \"input\": {\"user\": \"bob\", \"action\" : \"whitelist\", \"app_name\" : \"Wondershare Web Engine\", \"protocol\" : \"NET_FW_IP_PROTOCOL_TCP\", \"port_name\" : \"WWW\"} }";
